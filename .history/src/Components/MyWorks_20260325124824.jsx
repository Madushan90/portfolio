        ...
        <div className='grid sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 mb-25 gap-4'>
            ...
            <div className='col-span-8'>
                <div className='flex text-white'>
                    <ul>
                        <li><b>Admin Dashboard:</b> Developed a comprehensive admin dashboard with user authentication, role-based access control, and dynamic data visualization using Chart.js.</li>
                        ...
                        <li><b>Data Visualization:</b> Developed a comprehensive admin dashboard with user authentication, role-based access control, and dynamic data visualization using Chart.js.</li>
