            ...
            <div className='col-span-8'>
                <div className='flex text-white  h-full'>
                    <ul class="flex flex-col justify-center gap-4">
                        <li><b>Modern React Architecture</b> <br/> Expertly utilizes functional components and hooks (useState, useEffect) for real-time state and dynamic UI updates.</li>
