  ...
  return (
    <div id="portfolio" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8 place-items-center mb-25'>
            <div className='col-span-1 bg-red-400'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nostrum, eius! Voluptas eveniet non doloremque earum neque voluptatibus, dolorum facere, ad eligendi quidem quo magni quasi quisquam nemo reiciendis ut quod.</div>
