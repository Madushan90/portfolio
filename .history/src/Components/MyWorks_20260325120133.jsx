...
const MyWorks = () => {
  return (
    <div id="portfolio" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-0 place-items-center mb-25'>
            <div class='grid lg:grid-cols-2'>
                ...
                <div>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque, non neque, dolores, quas repellat eveniet sed eligendi mollitia cumque possimus dolorum aspernatur veritatis blanditiis ipsum placeat voluptatibus. Repellat, mollitia qui?
                </div>
            </div>
