    ...
    <div id="about" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        <div className="flex flex-col md:flex-row gap-10 items-center px-4 md:px-0">
            <div className="flex-1">
                <img className='w-90 mx-auto rounded-full border-0 border-cyan-700 outline-10 outline-offset-0 outline-pink-500 hover:outline-amber-400 to-20% outline-cyan-600' src={AboutImage} alt='profile banner' />
                <div className='mt-8'>
