            ...
            <div>
                <div className='p-5 bg-cyan-800/10'>
                    <form>
                        ...
                        <div class="flex items-center rounded-md bg-white/5 pl-3 outline-5 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
