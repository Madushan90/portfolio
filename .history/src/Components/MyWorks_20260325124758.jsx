            ...
            <div className='col-span-8'>
                <div className='flex text-white'>
                    <ul>
                        ...
                        <li><b>Advanced UI/UX:</b> Developed a comprehensive admin dashboard with user authentication, role-based access control, and dynamic data visualization using Chart.js.</li>
