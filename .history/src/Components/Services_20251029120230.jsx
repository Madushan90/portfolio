    ...
    <div className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {servicesData.map((service, index)=>{
                return (
                    <div key={index} className='inline-block border-1 border-white/30 text-white hover:bg-linear-120 from-orange-500/10 to-yellow-600/20 rounded-2xl p-8 transform hover:scale-102 hover:shadow-2xl  transition-all duration-500'>
