  ...
  return (
    <div className='mx-auto max-w-7xl sm:px-6 lg:px-8 pt-36 px-4 md:px-0'>
        <div className='relative'>
           <h1 className='text-white text-center text-5xl font-extralight mb-15 bg-amber-400 overflow-hidden'>Services</h1>
           <img src={BgLine} className='absolute top-1/2 left-1/2 transform -translate-x-2 -translate-y-1 w-40 h-22' alt='topic-image' />
        </div>
