                    ...
                    <form>
                        <div className='mb-5'>
                            ...
                            <div class="flex items-center rounded-md bg-black/20 mt-0.5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                                <input type="text" name="username" placeholder="janesmith" className="block min-w-0 grow bg-transparent py-3 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" />
                            </div>
                        </div>
                        <div className='mb-5'>
                        ...
                        <div className='mb-5'>
                            ...
                            <div class="flex items-center rounded-md bg-black/20 mt-0.5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                                <textarea name="about" rows="4" className="block min-w-0 grow bg-transparent py-3 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" ></textarea>
                            </div>
                        </div>
                        <div>
                            <a className='inline-block text-amber-300 border-2 border-double border-amber-500 rounded-3xl px-4 py-2.5 text-center bg-transparent transition-all duration-200 hover:shadow-xl hover:bg-amber-500 hover:text-white' href='#'>Download CV</a>
                        </div>
                    </form>
                </div>
            </div>
