...
const Services = ({TopicImage}) => { 
  return (
    <div className='mx-auto max-w-7xl sm:px-6 lg:px-8 pt-36 px-4 md:px-0'>
        <div className='relative1 flex flex-col justify-center items-center text-center'>
           <h1 className='text-white text-5xl font-extralight mb-15 overflow-hidden'>Services</h1>
           <img src={BgLine} className='absolut1e top1-1/2 left1-1/2 transform translate1-x-1/2 translate1-y-1/2 rotate-0.5 w-50' alt='topic-image' />
        </div>
