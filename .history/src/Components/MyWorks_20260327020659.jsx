    ...
    <div id="portfolio" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 mb-10 gap-4'>
            ...
            <div className='md:col-span-8'>
                <div className='flex text-gray-300 font-light text-sm tracking-wide h-full bg-slate-900/15 pl-5 rounded-xl py-5'>
                    <ul class="flex flex-col justify-center gap-4">
                        <li><b>GSAP-Scroll Interactivity:</b> Developed using React.js with functional components and Hooks (useState, useEffect) for efficient state and lifecycle management.</li>
