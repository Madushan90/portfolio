        ...
        <div className="flex flex-col md:flex-row gap-10 items-center px-4 md:px-0">
            <div className="flex-1">
                ...
                <div className='mt-8'>
                    ...
                    <div className='flex justify-center'>
                        <a href='https://www.behance.net/chamaramadhushan90' target='_blank' className='w-46 flex justify-center shadow-2xl border-slate-500 px-7 py-2.5 rounded-3xl transform hover:scale-105 transition-all duration-500 cursor-pointer hover:bg-slate-900 hover:border-slate-500/80'>
