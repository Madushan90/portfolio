            ...
            <div>
                <div className='p-5 bg-cyan-800/10'>
                    <form>
                        ...
                        <div>
                            <a className='inline-block text-amber-300 border-2 border-double border-amber-500 rounded-3xl px-4 py-2.5 text-center bg-transparent transition-all duration-200 hover:shadow-xl hover:bg-amber-500/5' href='#'>Download CV</a>
                        </div>
                    </form>
                </div>
            </div>
