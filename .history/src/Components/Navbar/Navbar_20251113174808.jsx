...
const Navbar = () => {
  ...
  return (
      <nav>
        ...
        {/* Mobile Menu */}
        <div className="md:hidden fixed flex justify-end w-full px-12">
          <Menu onClick={() => setsideBarOpen(true)} className='bg-white/80 text-white hover:text-amber-400 rounded-b-lg w-10 h-10 cursor-pointer pt-3 pb-1' />
        </div>
