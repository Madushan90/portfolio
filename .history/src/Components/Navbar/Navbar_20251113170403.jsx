...
const Navbar = () => {
  ...
  return (
      <nav>
        ...
        {/* Mobile Menu */}
        <div className="fixed flex justify-end bg-red-500 w-full">
          <Menu onClick={() => setsideBarOpen(true)} className='md:hidden text-white w-8 h-8 cursor-pointer hover:text-amber-400' />
        </div>
