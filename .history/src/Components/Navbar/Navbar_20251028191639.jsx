      ...
      <nav>
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-26">
              ...
              <div>
                <a className='text-white text-xl bg-gradient-to-r from-cyan-400 to-blue-500 border rounded-3xl px-6 py-2 hover:text-red-600  hover:scale-110' href='#'>Contact Me</a>
              </div>
            </div>
        </div>
      </nav>
