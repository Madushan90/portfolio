...
const Navbar = () => {
  ...
  return (
      <nav>
        ...
        <div class={`${sideBar ? "translate-x-0" : "translate-x-full"} fixed inset-y-0 right-0 z-50 w-80 bg-white/10 backdrop-blur-2xl border-r flex gap-3 border-white/20 transform transition-all duration-500 ease-out lg:translate-x-0 lg:static lg:inset-0`}>
