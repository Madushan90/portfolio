            ...
            <div className="flex items-center justify-between h-26">
              ...
              <div class="hidden sm:ml-6 md:block"> 
                <div class="flex space-x-4">
                  <AnchorLink href='#home'><p onClick={()=>setMenu("Home")} className="cursor-pointer rounded-full px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"><span>Home</span>{menu==="Home"? <img src={Underline} alt='underline-pattern' /> : <></>}</p></AnchorLink>
