...
import { MailIcon, LocateIcon } from 'lucide-react'
    ...
    <div className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-1 md:grid-cols-2 gap-8'>
            <div>
                ...
                <p className="text-white text-lg mt-10 mb-5">
                ...
                <div className='flex text-white'>
                    <MailIcon /><p className='text-lg ml-3 leading-normal'><a href="mailto:cmkumarathunga@gmail.com">cmkumarathunga@gmail.com</a></p> 
                </div>
            </div>
        </div>
    </div>
