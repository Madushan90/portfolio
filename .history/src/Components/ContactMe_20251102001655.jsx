                    ...
                    <form onSubmit={onSubmit} ref={formRef}>
                        <div className='mb-5'>
                            ...
                            <div className="flex items-center rounded-md bg-black/20 mt-0.5 pl-3">
                                <input type="text" name="name" placeholder="Name" className="block min-w-0 grow bg-transparent py-3 pr-3 pl-1 text-base text-white placeholder:text-gray-500 sm:text-sm/6 focus:bg-red-600" required />
                            </div>
                        </div>
                        <div className='mb-5'>
