...
import BgLine from '../../src/assets/bg-line.svg'
  ...
  return (
    <div className='mx-auto max-w-7xl sm:px-6 lg:px-8 pt-36 px-4 md:px-0'>
        <div className='relative'>
           ...
           <img src={BgLine} className='absolute top-1/2 left-1/2 transform -translate-x-10/12 -translate-y-1/4 w-20 h-20' alt='topic-image' />
        </div>
