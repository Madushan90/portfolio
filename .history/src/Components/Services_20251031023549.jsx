  ...
  return (
    <div className='mx-auto max-w-7xl sm:px-6 lg:px-8 pt-36 px-4 md:px-0'>
        <div className='relative bg-red-300'>
           <h1 className='text-white  text-center text-5xl font-extralight overflow-hidden'>Services</h1>
           <img src={BgLine} className='absolute top-10 left-1/2 right-1/2 transform translate-x-2 translate-y-0 w-100 rotate-0.5' alt='topic-image' />
        </div>
