            ...
            <div className='col-span-8'>
                <div className='flex text-white  h-full'>
                    <ul class="flex flex-col justify-center gap-4">
                        <li><b>Modern React Architecture</b> <br/> Utilizes functional components and hooks (useState, useEffect) for real-time state and dynamic UI updates.</li>

                        <li><b>Advanced UI/UX:</b> <br/> Implements a premium "glassmorphic" aesthetic using Tailwind CSS with backdrop-blur, custom gradients, and smooth micro-interactions.</li>

                        <li><b>Data Visualization:</b> <br/> Integrates Recharts for responsive, real-time financial analytics with custom SVG styling.</li>

                        <li><b>Component-Driven Development:</b> <br/> Engineered with reusable, prop-driven components (E.g., MetricCard, LiveActivityItem) for high maintainability.</li>

                        <li><b>Responsive Engineering:</b> <br/> Engineered with reusable, prop-driven components (E.g., MetricCard, LiveActivityItem) for high maintainability.</li>
                    </ul>
                </div>
            </div>
        </div>
