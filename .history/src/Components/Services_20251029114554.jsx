    ...
    <div className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {servicesData.map((service, index)=>{
                return (
                    <div key={index} className='inline-block border-3 border-amber-400/10 text-white hover:bg-gradient-to-r from-orange-500/50 to-yellow-600/50 rounded-xl px-4 py-2.5 transform hover:scale-102 hover:shadow-2xl transition-all duration-300'>
