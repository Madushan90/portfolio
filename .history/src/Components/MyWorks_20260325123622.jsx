    ...
    <div id="portfolio" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 mb-25 gap-4'>
            ...
            <div className='col-span-8 bg-blue-500'>
                <div className='flex'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis explicabo cumque quasi dolore sint temporibus, accusantium nisi reiciendis. Itaque consectetur dolorem aspernatur, exercitationem unde laudantium aliquid. Minus velit ipsam aperiam?
                </div>
            </div>
        </div>
