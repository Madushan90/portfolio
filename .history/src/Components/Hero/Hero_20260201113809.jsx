        ...
        <div className='flex items-center gap-10 md:gap-2 flex-col-reverse md:flex-row'>
            <div className='px-5 md:px-0'>
                ...
                <div className='flex items-center text-center gap-5 justify-center mt-10'>
                  <div>
                      <AnchorLink href='#contact'><p className='inline-block text-white bg-gradient-to-r from-orange-500 to-yellow-600 rounded-3xl px-4 py-2.5 text-center border-2 transform hover:scale-105 hover:shadow-2xl transition-all duration-200' href='#'>Contact Me</p></AnchorLink>
                  </div>
                  <div>
