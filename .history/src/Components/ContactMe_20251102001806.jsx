  ...
  return (
    <div id="contact" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <div>
                <div className='p-7 bg-cyan-800/10 rounded-2xl'>
                    {/* Attach the ref to the form element */}
                    <form onSubmit={onSubmit} ref={formRef}>
                        <div className='mb-5'>
                            <label htmlFor="username" className="block text-white">Name</label>
                            <div className="flex items-center rounded-md bg-black/80 mt-0.5 pl-3">
                                <input type="text" name="name" placeholder="Name" className="block min-w-0 grow bg-transparent py-3 pr-3 pl-1 text-base text-white placeholder:text-gray-500 sm:text-sm/6 focus-visible:bg-red-600" required />
                            </div>
                        </div>
                        <div className='mb-5'>
