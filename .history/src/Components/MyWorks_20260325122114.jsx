...
const MyWorks = () => {
  return (
    <div id="portfolio" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid sm:grid-cols-6 md:grid-cols-6 lg:grid-cols-6 mb-25'>
            <div className='col-span-3 bg-red-400'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nostrum, eius! Voluptas eveniet non doloremque earum neque voluptatibus, dolorum facere, ad eligendi quidem quo magni quasi quisquam nemo reiciendis ut quod.</div>
            <div className='col-span-3 bg-blue-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis explicabo cumque quasi dolore sint temporibus, accusantium nisi reiciendis. Itaque consectetur dolorem aspernatur, exercitationem unde laudantium aliquid. Minus velit ipsam aperiam?</div>
        </div>
