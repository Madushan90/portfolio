                ...
                <div className='p-5 bg-cyan-800/10'>
                    <form>
                        ...
                        <div>
                            ...
                            <div class="flex items-center rounded-md bg-black/20 mt-0.5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                                <textarea name="about" rows="5" className="block min-w-0 grow bg-transparent py-3 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" ></textarea>
                            </div>
                        </div>
                    </form>
                </div>
