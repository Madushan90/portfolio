...
const MyWorks = () => {
  return (
    <div id="portfolio" className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-36'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 mb-25 gap-4'>
            ...
            <div className='md:col-span-8'>
                <div className='flex text-gray-300 font-light text-sm tracking-widest h-full bg-slate-900/15 pl-5 rounded-xl py-5'>
                    <ul class="flex flex-col justify-center gap-4">
                        ...
                        <li><b>Data Visualization:</b> Integrates Recharts for responsive, real-time financial analytics with custom SVG styling.</li>
            ...
            <div className='md:col-span-8'>
                <div className='flex text-gray-300 font-light text-sm tracking-wide h-full bg-slate-900/15 pl-5 rounded-xl py-5'>
                    <ul class="flex flex-col justify-center gap-4">
                        ...
                        <li><b>External API Integration:</b> Implements a premium "glassmorphic" aesthetic using Tailwind CSS with backdrop-blur, custom gradients, and smooth micro-interactions.</li>
