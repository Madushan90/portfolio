...
const Services = ({TopicImage}) => { 
  return (
    <div id="services" className='mx-auto max-w-7xl sm:px-6 lg:px-8 pt-36 px-4 md:px-0'>
        <div className='relative'>
           <h1 className='text-white text-5xl font-extralight text-center mb-20'>Services</h1>
